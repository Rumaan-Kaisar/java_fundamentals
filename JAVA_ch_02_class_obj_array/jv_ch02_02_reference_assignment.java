...
primitive type variables and object reference variables and assignment
...
When you assign one object reference variable to another, 
    the situation is a bit more complicated because you are changing the object that the reference variable refers to. 
    The effect of this difference can cause some counterintuitive results. For example, 

Vehicle car1 = new Vehicle();
Vehicle car2 = car1;

Looks like car1 and car2 refer to different objects, but this is not the case. 
...
For example, after the assignment car1.mpg = 26; executes, both of following println() statements display the same value: 26.
...
For example, a subsequent assignment to car2 simply changes the object to which car2 refers. The object referred to by car1 is unchanged.
